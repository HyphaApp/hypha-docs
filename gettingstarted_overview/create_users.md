...
> ℹ️ _Only users with the ["Staff"](gettingstarted_overview/hypha_roles.md) Role can do this_
...
### 5. Select user Roles
In the [Roles] tab, specify the level of access you want your user to have by giving them specific Roles (see [Roles documentation](gettingstarted_overview/hypha_roles.mdß) for more information)
